...
public class QuizActivity extends AppCompatActivity {
    ...
    private void buildQuestionsList() {
        ...
        contexts.add("Based on SLQF, your course load (" + totalCredits + " credits) requires " + totalNotionalHours + " total hours (lectures, labs & self-study). We recommend aiming for at least " + targetStudyHours + " hours of focused self-study per week.");
        questionTypes.add(1);
        answers.add(0.0);
